...
/// SmartCaseKit's own minimal logger, built on os.Logger
enum SmartCaseLogger {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.bragi.SmartCaseKit", category: "SmartCaseKit")
